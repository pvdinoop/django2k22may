...
# 2. total no of available mobiles ??
# 3. No of out of stock mobiles ??
# 4. Total stock ??
# 5. Mobiles in the range of 20k-30k ??
# 6. Print all 5g phones ??
# 7. Print all samsung mobiles ??
# 8. Print costly mobiles ??
# 9. print all mobiles having stock greater than 10 ??
# 10.Count of mobiles having amoled display ??
# 11.Sort all mobiles based on price ??
# 12 Sort all mobiles based on available stock in descending order ??
# 13 is there any mobiles available at 10000
# 14 mobiles available at same price
...
# q10 sort mobiles based on price
